        ...
        <div class="row">
                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-12 col-sm-5 mb-2">
                                    <?php echo admin_filter_search_html('riders_filter_search'); ?>
                                </div>
                                <div class="col-12 col-sm-7">
                                    <div class="d-flex justify-content-end">
                                        <?php echo admin_filter_status_html('riders_filter_status'); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            if (!empty($this->data['items']) <= 0) {
                ...
                for ($i = 0; $i < $n; ++$i) {
                    ...
                    $link_edit = base_url('/admin_riders_edit.php?id='.$row['id'].'&per_page='.$per_page);
                    $link_restore = base_url('/admin_riders_restore.php?id='.$row['id'].'&per_page='.$per_page);
                    $link_trash = base_url('/admin_riders_trash.php?id='.$row['id'].'&per_page='.$per_page);
                    $link_delete = base_url('/admin_riders_delete.php?id='.$row['id'].'&per_page='.$per_page);

                    $status_link = base_url('/admin_riders_unpublish.php?id='.$row['id'].'&per_page='.$per_page);
                    if ($row['status'] == 0) {
                        $status_link = base_url('/admin_riders_publish.php?id='.$row['id'].'&per_page='.$per_page);
                    } ?>
                                <div class="row gy-2">
                                    ...
                                    <div class="col-12 col-md-2">
                                        <div class="d-flex">
                                            ...
                                            <?php
                                            if (get_filter_status('riders_filter_status') == 'trash') {
                                                ?>
